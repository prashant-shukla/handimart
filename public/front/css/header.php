   ...
   <div class="wsmobileheader clearfix">
      ...
      <span class="smllogo"><img src="images/footer-logo.png" width="200" alt="" /></span>
      ...
      <div class="wssearch clearfix">
         <a href="" class="text-center"><img src="images/cart.png" alt="My Account">
         </a>
         <a href="" class="text-center"><img src="images/my-account.png" alt="My Cart">
         </a>
      </div>
   </div>
   <!-- Mobile Header -->
         ...
         <nav class="wsmenu clearfix">
            <ul class="wsmenu-list">
               <li aria-haspopup="true">
                  <a href="#" class="navtext"><span>Carftsmen
                  </span></a>
                  <div class="wsshoptabing wtsdepartmentmenu clearfix">
                     <div class="wsshopwp clearfix">
                        <ul class="wstabitem clearfix">
                           <li class="wsshoplink-active">
                              <a href="#"><i class="fas fa-female"></i> Women's Wear &amp; Items</a>
                                             ...
                                             <div id="demo" class="carousel slide" data-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                   <div class="carousel-item active">
                                                      <img src="images/woman-ad-img.jpg" alt="" />
                                                      <div class="carousel-caption">
                                                         <h3>Slider Caption 11</h3>
                                                      </div>
                                                   </div>
                                                   <div class="carousel-item">
                                                      <img src="images/woman-ad-img02.jpg" alt="" />
                                                      <div class="carousel-caption">
                           ...
                           <li>
                              <a href="#"><i class="fas fa-male"></i> Men's Wear &amp; Items</a>
                              <div class="wstitemright clearfix">
                                 <div class="container-fluid">
                                    <div class="row">
                                       ...
                                       <div class="col-lg-4 col-md-12 clearfix"><a href="#" class="wstmegamenucolr"><img src="images/man-ad-img.jpg"
                                          alt=""></a></div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <li>
                              <a href="#"><i class="fas fa-play-circle"></i> Movies, Music &amp; Games</a>
                              <div class="wstitemright clearfix">
                                 <div class="container-fluid">
                                    <div class="row">
                           ...
                           <li>
                              <a href="#"><i class="fas fa-utensils"></i>Home &amp; Kitchen</a>
                           ...
                           <li>
                              <a href="#"><i class="fas fa-tv"></i>Electronics Appliances</a>
                              <div class="wstitemright clearfix">
                                 <div class="container-fluid">
                                    <div class="row">
                                       <div class="col-lg-3 col-md-12">
                           ...
                           <li>
                              <a href="#"><i class="fas fa-laptop"></i>Computers &amp; Game</a>
                           ...
                           <li>
                              <a href="#"><i class="fas fa-car"></i>Auto accessories</a>
                           ...
                           <li>
                              <a href="#"><i class="fas fa-heartbeat"></i>Health Care Products</a>
                              <div class="wstitemright clearfix wstpngsml">
                                 <div class="container-fluid">
                                    <div class="row">
               ...
               <li aria-haspopup="true">
                  <a href="#" class="navtext"> <span>Exporter & Manufacture
                  </span></a>
               ...
               <li aria-haspopup="true">
                  <a href="#" class="navtext"><span>Our Product
                  </span></a>
               ...
               <li aria-haspopup="true"><a href="#" class="navtext"><span>Buyer Requirement</span></a>
               </li>
               <li aria-haspopup="true">
                  <a href="#" class="navtext"><span>More<i class="fal fa-angle-down"></i></span></a>
               ...
               <li class="wscarticon clearfix">
                  <a class="membership" title="Membership" href="#"><span>+</span>Membership</a>
               </li>
               <!-- 
                  <li aria-haspopup="true" class="wsshopmyaccount"><a href="#"><i class="fas fa-align-justify"></i>My&nbsp;Account</a>
                    <ul class="sub-menu">
                      ...
                      <li><a href="#"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                           ...
                           -->
               <li aria-haspopup="true" class="wsshopmyaccount account_li d-none d-md-block">
                  <div class="side_border2"></div>
                  <a href="" class="text-center"><img src="images/my-account.png" alt="My Account">
   ...
   <!--  <div class="navigation-wrap web_navbar start-header start-style">
      <div class="container">
         <div class="row">
            <div class="col-12 paddding_remove">
               <nav class="navbar navbar-expand-md navbar-light">
                  <a class="navbar-brand outer_logo" href="" title="Handimart" ><img src="images/logo.png" alt="logo"></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav py-4 py-md-0">
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active">
                           <a class="nav-link text-capitalize"  href=""  title="Carftsmen">Carftsmen</a>
                        </li>
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                           <a class="nav-link text-capitalize" href="" title="Exporter & Manufacture " >Exporter & Manufacture </a>
                        </li>
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                           <a class="nav-link text-capitalize" href="#" title="Our Product">Our Product</a>
                        </li>
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                           <a class="nav-link text-capitalize" href=""  title=" Buyer Requirement "> Buyer Requirement </a>
                        </li>
                        <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                           <a class="nav-link text-capitalize" href=""  title=" More"> More<i class="fal fa-angle-down"></i> </a>
                     ...
                     <ul class="right_panel d-md-block d-none">
                        <li>
