                        ...
                        <div class="row align-items-center mb20">
                            <div class="col-md-6">
                                <div class="text-center text-md-start">
                                    <p class="text mb-0 mb10-sm"><span class="fw500">{{ $designers->count() }}</span>
                                    ...
                                    <div class="freelancer-style1 text-center bdr1 hover-box-shadow">
                                        <div class="thumb w90 mb25 mx-auto position-relative ">
                                            <img class="rounded-circle mx-auto"
                                                src="{{ get_user_profile_pic($designer->id) }}" alt=""
                                                width="100px" height="103px">
                                            <span class="online"></span>
                                        </div>
                                        <div class="details">
                                            <h5 class="title mb-1">
                                                {{ $designer->first_name ?? $designer->username }}
                                                {{ $designer->last_name ?? $designer->username }}
                                            </h5>
                                            <p class="mb-0">{{ $designer->public_name }}</p>
                                            <div class="review">
                                            ...
                                            <div class="fl-meta d-flex align-items-center justify-content-between">
                                                <a class="meta fw500 text-start">Location<br><span
                                                        class="fz14 fw400">{{ $designer->address }}</span></a>
                                                <a class="meta fw500 text-start">Rate<br><span class="fz14 fw400">$90
                                                        /
                                                        hr</span></a>
                                                <a class="meta fw500 text-start">Exp.<br><span
                                                        class="fz14 fw400">2</span></a>
                                            </div>
                                            <div class="d-grid mt15">

                                                <a href="{{ url('designer_detail', $designer->id) }}"
                                                    class="ud-btn btn-light-thm">View
