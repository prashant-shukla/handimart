                            ...
                            <div id="collapseZero" class="collapse show" aria-labelledby="headingZero"
                                ...
                                <div class="card-body card-body px-0 pt-0">
                                    <div class="checkbox-style1">
                                        {{-- @foreach ($craftmanCategorys as $craftmanCategory)
                                            <label class="custom_checkbox">{{ $craftmanCategory->name }}
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                                <span class="right-tags">({{ $craftmanCategory->where()->count() }})</span>
                                            </label>
                                        @endforeach --}}

                                    </div>
                                    {{-- <a class="text-thm" href="#">{{ $craftmanCategorys->total() }} + total
                                    </a> --}}
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseTwos" class="collapse" aria-labelledby="headingTwos"
                                ...
                                <div class="card-body card-body px-0 pt-0">
                                    ...
                                    <div class="checkbox-style1 mb15">
                                        @foreach ($userCountryBaseCounts as $country)
                                            <label class="custom_checkbox">{{ $country->country_name }}
                                                <input type="checkbox">
                                                <span class="checkmark"></span>
                                                <span class="right-tags">({{ $country->total_users }})</span>
                                            </label>
                                        @endforeach
                    ...
                    <div class="col-lg-12">
                        <div class="breadcumb-style1">
                            <div class="breadcumb-list">
                                ...
                                <a href="#">Services</a>
                                <a
                                    href="{{ route(Route::currentRouteName()) }}">{{ \Str::ucfirst(Route::currentRouteName()) }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row wow fadeInUp">
                        <div class="col-xl-5">
                            <div class="position-relative">
                                <h2>Craftmens</h2>
                                <p class="text mb-0">All the Lorem Ipsum generators on the Internet tend to
                                    repeat.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card mb20 pb10 mt-0">
                                    <div class="card-header active" id="heading0">
                                        <h4>
                                            <button class="btn btn-link ps-0 pt-0" type="button"
                                                ...
                                                aria-expanded="true" aria-controls="collapse0">Category</button>
                                        </h4>
                                    </div>
                                    <div id="collapse0" class="collapse show" aria-labelledby="heading0"
                                        ...
                                        <div class="card-body card-body px-0 pt-0">
                                            <div class="checkbox-style1 mb15">
                                                <Form action="{{ route('craftman') }}" method="GET">
                                                    @csrf
                                                    @foreach ($craftmanCategorys as $craftmanCategory)
                                                        <label class="custom_checkbox">{{ $craftmanCategory->name }}
                                                            <input type="checkbox" name="category[]"
                                                                value="{{ $craftmanCategory->name }}"
                                                                onChange="this.form.submit()">
                                                            <span class="checkmark"></span>
                                                            <span
                                                                class="right-tags">({{ $craftmanCategory->users_count }})</span>
                                                        </label>
                                                    @endforeach

                                                </Form>
                                            </div>
                                            <a class="text-thm" href="#">0 + total
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row align-items-center mb20">
                            <div class="col-md-6">
                                <div class="text-center text-md-start">
                                    <p class="text mb-0 mb10-sm"><span class="fw500">{{ $craftmans->count() }}</span>
                                        ...
                                        <ul class="p-0 mb-0 text-center text-md-start">
                                            <li>
                                                ...
                                                <button type="button" class="open-btn filter-btn-left">
                                                    <img class="me-2" src="images/icon/all-filter-icon.svg"
                            ...
                            @foreach ($craftmans as $craftman)
                                <div class="col-sm-6 col-xl-4">
                                    <div class="freelancer-style1 text-center bdr1 hover-box-shadow">
                                        <div class="thumb w90 mb25 mx-auto position-relative ">
                                            <img class="rounded-circle mx-auto"
                                                src="{{ get_user_profile_pic($craftman->id) }}" alt=""
                                                width="100px" height="103px">
                                            <span class="online"></span>
                                        </div>
                                        <div class="details">
                                            <h5 class="title mb-1">
                                                {{ $craftman->first_name ?? $craftman->username }}
                                                {{ $craftman->last_name ?? $craftman->username }}
                                            </h5>
                                            <p class="mb-0">{{ $craftman->public_name }}</p>
                                            <div class="review">
                                            ...
                                            {{-- <div class="skill-tags d-flex align-items-center justify-content-center mb5">
                                                @foreach ($craftman->craftmanSkills as $skill)
                                            ...
                                            <div class="fl-meta d-flex align-items-center justify-content-between">
                                                ...
                                                <a class="meta fw500 text-start">Exp.<br><span
                                                        class="fz14 fw400"> @if($craftman->business) {{ $craftman->business->experience }}+ @endif</span></a>
                                            </div>
                                            <div class="d-grid mt15">

                                                <a href="{{ url('craftman_detail', $craftman->id) }}"
                                                    class="ud-btn btn-light-thm">View Profile<i class="fal fa-arrow-right-long"></i></a>
