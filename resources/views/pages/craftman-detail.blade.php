...
<section class="breadcumb-section pt-0">
    ...
    <div
        ...
        <div class="container">
            <h3 class="">A Walk Through {{ $user->first_name ?? $user->username }} Creative Journey</h3>
                        ...
                        <div class="list-meta d-sm-flex align-items-center mt30">
                            ...
                            <a class="position-relative freelancer-single-style" href="#">
                                ...
                                <img class="rounded-circle wa-sm mb15-sm"
                                    src="{{ get_user_profile_pic($user->id) }}"
                            ...
                            <div class="ml20 ml0-xs">
                                ...
                                <p class="mb-0 dark-color fz15 fw500 list-inline-item ml15 mb5-sm ml0-xs"><i
                                        class="flaticon-30-days vam fz20 me-2"></i>Member since {{ optional($user->created_at)->format('F d, Y') ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="blog-sidebar ms-lg-auto">
                    <div class="price-widget pt25 widget-mt-minus bdrs8">
                        ...
                        <div class="d-grid">
                            ...
                            <a href="javascript:void(0)" class="ud-btn btn-thm text-center" id="showNumberBtn">

                                <div>
                                    Contact Me <i class="fal fa-arrow-right-long"></i>
                                </div>

                                @if (Auth::check())
                                <small id="phoneNumber" class="d-block text-center text-size-16 fw500">
                                    Show Number
                                </small>
                                @endif
                            ...
                            <!-- Send Message Button -->
                            <a href="#"
                                class="send-message-btn text-center mt-1">
                                Send a Message
                            </a>
                        </div>
                        ...
                        <script>
                            document.getElementById('showNumberBtn').addEventListener('click', function() {
                                document.getElementById('phoneNumber').innerHTML =
                                    '<a href="tel:+91{{ $user->phone }}" class="text-white phonenumber text-size-16">+91 {{ $user->phone }}</a>';
                            });
                        </script>
                        <div class="category-list mt20">
                        ...
                        <div class="category-list mt20">
                            <a class="d-flex align-items-center justify-content-between bdrb1 pb-2" href="#">
                                <span class="text">
                                    <i class="flaticon-place text-thm2 pe-2 vam"></i> Work in
                                </span>
                        ...
                        <div class="category-list mt20">
                            <a class="d-flex align-items-center justify-content-between bdrb1 pb-2" href="#">
                                <span class="text"><i class="flaticon-place text-thm2 pe-2 vam"></i>Gender</span>
