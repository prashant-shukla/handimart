                          ...
                          <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ml-2">
                                  <p><a href="{{ url('dashboard/photographers/my-profile/profile/'.$id.'/'.$recevied->sender_id) }}" class=" userNameReview" style="display: inline-block;">{{$recevied->sender_name}},
                            ...
                            <div class="collapse mt-1" id="collapseExample{{$recevied->id}}">
                              ...
                              <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ml-2">
                                    <p><a href="{{ url('dashboard/photographers/my-profile/profile/'.$id.'/'.$review_reply->sender_id) }}" class=" userNameReview" style="display: inline-block;">{{$review_reply->name}},
                          ...
                          <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ml-2">
                                  <p><a href="{{ url('dashboard/photographers/my-profile/profile/'.$id.'/'.$submitted->receiver_id) }}" class=" userNameReview" style="display: inline-block;">{{$submitted->receiver_name}},
...
<script>
  var root_path = "{{URL::to('dashboard/photographers/reviews')}}";
