            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    ...
                    <div class="d-flex align-items-center flex-wrap text-nowrap">
                        <a class="btn btn-primary add-new-button" href="{{ url('dashboard/photographers/jobs_a/create/'.$id) }}"><i class="btn-icon-prepend"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dmenucustom" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                                href="{{ url('dashboard/photographers/jobs_a/job_preview',[$job_data->id,$id]) }}"><i
                                                    class="link-icon" data-feather="eye"></i>View Preview</a>
                                            <a class="dropdown-item"
                                                href="{{ url('dashboard/photographers/jobs_a/edit',[$job_data->id,$id]) }}"><i
...
<script>
    var root_path = "{{URL::to('dashboard/photographers/jobs_a')}}";
