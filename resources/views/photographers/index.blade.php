            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                  <div>
                    <h4 class="mb-3 mb-md-0">Photographers</h4>
                  </div>
                      ...
                      @if(count($user_list) > 0)
                        @foreach ($user_list as $user_data)
                          <tr>
                            ...
                            <td class="text-right">
                              <a class="btn btn-secondary custom-btn-1" href="{{ url('dashboard/photographers/my-profile/personal-detail',$user_data->id) }}">
                              <i class="link-icon" data-feather="edit"></i> Edit</a>
                              @if ($user_data->is_approved != 1)
                                <a class="btn btn-success custom-btn-2" href="{{ url('dashboard/photographers/approve-account',$user_data->id) }}"><i class="link-icon" data-feather="check-circle"></i> Approve</a>
                              @endif
                            </td>
                          </tr>
                        @endforeach
