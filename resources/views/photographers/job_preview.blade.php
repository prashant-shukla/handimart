...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('dashboard/photographers/jobs/'.$job_id) }}">Jobs</a></li>
                ...
                <div class="row pd-left-15">
                    ...
                    <div class="col-md-6 mt-15">
                        ...
                        <label class="job_website">
                            <a href="{{$jobs->website}}" target="_blank"><i class="fa fa-link"></i>
                                {{$jobs->website}}</a>
                        </label>
                        @endif
                        @if($jobs->url_email != '')
                        <label class="job_website">
                            <a href="{{$jobs->url_email}}" target="_blank"><i class="fa fa-link"></i>
                                {{$jobs->url_email}}</a>
                        </label>
                        @endif
                        @if($jobs->twitter != '')
                    ...
                    <div class="col-md-4 text-right horizontal-center">
                        <div class="horizontal-center-inner">
                            <a href="{{URL::to('dashboard/photographers/jobs_a/edit/'.$job_id.'/'.$id)}}"
                                class=" btn btn-outline-dark btn-custom-1" title="Edit"><i
                                    class="fa fa-pencil-square-o"></i></a>
                            <a href="{{URL::to('dashboard/photographers/jobs_a/post_now/'.$job_id.'/'.$id)}}"
                                class="btn btn-success btn-custom-2">Post Now</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-3 pt-0 pl-0 pr-0 mb-4">
                                        ...
                                        <div class="container mb-4 mb-xl-0">
                                            ...
                                            <div class="middle">
                                                <div class="text">
                                                    <a href="{{url('dashboard/photographers/jobs/image_delete/'.$image_data->id).'/'.$id}}"
                    ...
                    <ul>
                        <li>
                            ...
                            <div>
                                ...
                                <span><time datetime="{{ date('Y-d-m', strtotime($jobs->created_at)) }}">{{ date('F jS,
                                        Y', strtotime($jobs->created_at)) }}</time></span>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div>
                                ...
                                <span class="location"><a class="google_map_link" href="{{$jobs->map_location}}"
                        ...
                        <li>
                            ...
                            <div>
                                <strong>Video:</strong>
                                <span class="location"><a class="video_url" href="{{$jobs->video_url}}"
