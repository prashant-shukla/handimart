...
<form enctype="multipart/form-data" action="{{url('dashboard/photographers/job_store/'.$id)}}" method="post" id="job_create_form" enctype="multipart/form-data" >
    @csrf
<div class="row ">
...
<script>
    var root_path = "{{URL::to('photographers')}}";
