...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('photographers.skills') }}">Skills</a></li>
...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Update Photographers Skill</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/photographers/skill_update/'.$id)}}" method="post"
                    class="parsley-examples" id="photographer_skill_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
