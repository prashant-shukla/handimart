                                        ...
                                        <div class="tab-content p-3" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade @if ($page_title == 'personal-detail') active show @endif"
                                                ...
                                                <form enctype="multipart/form-data"
                                                    action="{{ url('dashboard/clients/my-profile/personal_submit/' . $id) }}"
                                                    method="post" id="clients_personal_details_form">
                                                    @csrf
                                            ...
                                            <div class="tab-pane fade @if ($page_title == 'social-detail') active show @endif"
                                                ...
                                                <form
                                                    action="{{ url('dashboard/clients/my-profile/social_submit/' . $id) }}"
                                                    method="post" class="parsley-examples"
                                                    id="client_social_details_form">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                            ...
                                            <div class="tab-pane fade @if ($page_title == 'update-password') show active @endif"
                                                ...
                                                <form id="signupForm" method="post"
                                                    action="{{ url('dashboard/clients/my-profile/password_submit/' . $id) }}">
                                                    @csrf
                                                    @if (session('error') != '')
