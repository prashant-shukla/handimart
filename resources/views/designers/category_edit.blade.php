...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('designers') }}">Designer</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('designers.categories') }}">Categories</a></li>
...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Update Designer Categories</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/designers/category_update/'.$id)}}" method="post"
                    class="parsley-examples" id="designer_category_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="parent_id" class="control-label">Parent Designer Category</label>
