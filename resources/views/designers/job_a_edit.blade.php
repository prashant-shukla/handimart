...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('dashboard/designers/jobs/'.$job_id) }}">Requirements</a></li>
        <li class="breadcrumb-item active" aria-current="page">Update Requirement</li>
    </ol>
</nav>

<form enctype="multipart/form-data" action="{{url('dashboard/designers/jobs_a/job_a_update/'.$job_id.'/'.$id)}}" method="post" id="job_create_form" enctype="multipart/form-data" >
    @csrf
<div class="row ">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($job_images as $images)
                                ...
                                <img src="{{ $images->image_thumb_path }}" style="height: 140px" class="image card-img-top" alt="...">
                                    <div class="middle">
                                    <div class="text">
                                        <a href="{{url('dashboard/designers/jobs/image_delete_edit/'.$images->id).'/'.$id}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Image">
