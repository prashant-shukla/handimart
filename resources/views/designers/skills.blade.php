...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Add New Designers Skills</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/designers/skill_store')}}" method="post"
                    class="parsley-examples" id="designer_skill_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">Designers Skills<lls/h4>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-secondary custom-btn-1"
                                        href="{{ url('dashboard/designers/skill_edit',$skills_list->id) }}">
