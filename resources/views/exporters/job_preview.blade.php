...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('dashboard/exporters/jobs/'.$job_id) }}">Jobs</a></li>
                ...
                <div class="row pd-left-15">
                    ...
                    <div class="col-md-4 text-right horizontal-center">
                        <div class="horizontal-center-inner">
                            <a href="{{URL::to('dashboard/exporters/jobs_a/edit/'.$job_id.'/'.$id)}}"
                                class=" btn btn-outline-dark btn-custom-1" title="Edit"><i
                                    class="fa fa-pencil-square-o"></i></a>
                            <a href="{{URL::to('dashboard/exporters/jobs_a/post_now/'.$job_id.'/'.$id)}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-3 pt-0 pl-0 pr-0 mb-4">
                                        ...
                                        <div class="container mb-4 mb-xl-0">
                                            ...
                                            <div class="middle">
                                                <div class="text">
                                                    <a href="{{url('dashboard/exporters/jobs/image_delete/'.$image_data->id).'/'.$id}}"
