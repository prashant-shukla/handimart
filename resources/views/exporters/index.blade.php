            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                  <div>
                    <h4 class="mb-3 mb-md-0">Exporters</h4>
                  </div>
                          ...
                          <tr>
                            ...
                            <td class="text-right">
                              ...
                              @if ($user_data->is_approved != 1)
                                <a class="btn btn-success custom-btn-2" href="{{ url('dashboard/exporters/approve-account',$user_data->id) }}"><i class="link-icon" data-feather="check-circle"></i> Approve</a>
                              @endif
                            </td>
                          </tr>
                        @endforeach
