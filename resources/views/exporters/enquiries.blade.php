                                            ...
                                            <ul class="list-unstyled chat-list px-1">
                                                ...
                                                @foreach($all_messages as $message_data)
                                                    <li class="chat-item pr-1">
                                                        <a href="{{ url('dashboard/exporters/enquiries/'.$id.'/'.$message_data->contact_id) }}" class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center aasdiv">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-end text-body">
                                                                <a href="{{ url('dashboard/exporters/enquiries/start_chat/'.$id.'/'.$contact_data->contact_user_data->id) }}">
                                                                    <i  data-feather="message-square" class="icon-md text-success mr-2" data-toggle="tooltip"
                                                                    title="Start Chat"></i>
                                                                </a>
                                                                <a href="{{ url('dashboard/exporters/enquiries/remove_contact/'.$id.'/'.$contact_data->contact_user_data->id.'/'.$enq_id) }}">
                        ...
                        <div class="chat-header border-bottom pb-2">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex align-items-center mr-n1">
                                    @if($added_contact == 1) 
                                    <a href="{{ url('dashboard/exporters/enquiries/remove_contact/'.$id.'/'.$messages_user_data_all->id.'/'.$enq_id) }}" class="d-none d-sm-block">
                                        <i data-feather="user-minus" class="icon-lg text-muted" data-toggle="tooltip"
                                            title="Remove from contacts"></i>
                                    </a>
                                    @else
                                    <a href="{{ url('dashboard/exporters/enquiries/save_contact/'.$id.'/'.$messages_user_data_all->id.'/'.$enq_id) }}" class="d-none d-sm-block">
...
<script>
    var root_path = "{{URL::to('dashboard/exporters/enquiries')}}";
