...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Add New Exporter Categories</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/exporters/category_store')}}" method="post"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="parent_id" class="control-label">Parent Exporter Category</label>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">Exporter Categories</h4>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-secondary custom-btn-1"
                                        href="{{ url('dashboard/exporters/category_edit',$category_data->id) }}">
