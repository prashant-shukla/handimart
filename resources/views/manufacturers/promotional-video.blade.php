      ...
      <div class="card-body">
        <h6 class="card-title mb-2">Promotional Video</h6>
          <p class="text-muted cborder-bottom">Change your promotional video details which are related to your account</p><hr class="mt-2">
                <form action="{{url('dashboard/manufacturers/business-profile/promotional_submit/'.$id)}}" method="post" class="parsley-examples">
                  @csrf              
          ...
          <div id="job-menu" class="text-right col-sm-auto pl-0 pr-0">
            <ul class="list-inline mb-0">
              <li class="list-inline-item">
                <a href="{{url('dashboard/manufacturers/business-profile/delete_promotional/'.$id.'/'.$video->id)}}" class="text-custom d-inline-block" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Video">
