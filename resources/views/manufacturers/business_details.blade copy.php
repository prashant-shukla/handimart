  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        ...
        <p class="text-muted cborder-bottom">Add your business details which are related to your account</p>
        <hr class="mt-2">
        <form action="{{url('dashboard/manufacturers/business-profile/business_submit/'.$id)}}" method="post"
          class="parsley-examples" id="business_details_form" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input id="phone" class="form-control isValidPhone" name="phone" type="text"
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name='category' class="form-control">
                  ...
                  @if(count($manufacturer_categories) > 0)
                  @foreach ($manufacturer_categories as $manufacturer_cat)
                  <option value="{{$manufacturer_cat->id}}">{{$manufacturer_cat->name}}</option>
                  @endforeach
                  @endif
                </select>
              </div>
            ...
            <div class="col-sm-6">
              <div class="form-group mb-0">
                ...
                <div class="row">
                  ...
                  @if(count($manufacturer_skills) > 0)
                  @php $indexVal = 1; @endphp
                  @foreach ($manufacturer_skills as $manufacturer_skill)
                  <div class="col-sm-4">
                    <div class="custom-control custom-checkbox mb-2">
                      <input name='skills[]' value='{{$manufacturer_skill->name}}' type="checkbox"
                        class="custom-control-input" id="customCheck{{$indexVal}}">
                      <label class="custom-control-label"
                        for="customCheck{{$indexVal}}">{{$manufacturer_skill->name}}</label>
                    </div>
                  </div>
                  @php $indexVal++; @endphp
                  @endforeach
        ...
        @else
        <p class="text-muted cborder-bottom">Update your business details which are related to your account</p>
        <hr class="mt-2">
        <form action="{{url('dashboard/manufacturers/business-profile/business_submit/'.$id)}}" method="post"
          class="parsley-examples" id="business_details_form" enctype="multipart/form-data">
          @csrf
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label">Company Name</label>
                <input name="company_name" type="text" class="form-control" placeholder="Enter Company Name"
                  value="{{ $business_detail->company_name }}">
              </div>
            </div><!-- Col -->
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    <input id="phone" class="form-control isValidPhone" name="phone" type="text"
                      placeholder="0123456789" value="{{ $business_detail->phone }}">
                  </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name='category' class="form-control">
                  ...
                  @if(count($manufacturer_categories) > 0)
                  @foreach ($manufacturer_categories as $manufacturer_cat)
                  <option value="{{$manufacturer_cat->id}}" @if($manufacturer_cat->id==$business_detail->category )
                    selected @endif >{{$manufacturer_cat->name}}</option>
                  @endforeach
                  @endif
                </select>
              </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label">Experience</label>
                <input name="experience" type="number" class="form-control" placeholder="Enter Experience"
                  value="{{ $business_detail->experience }}">
              </div>
            </div><!-- Col -->
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label">All Over Job Done</label>
                <input name="job_done" type="text" class="form-control" placeholder="Enter All Over Job Done"
                  value="{{ $business_detail->job_done }}">
              </div>
            </div><!-- Col -->
          </div><!-- Row -->
              ...
              <div class="form-group mb-0">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="custom-control custom-checkbox mb-2">
                      <input name='skills[]' value='{{$manufacturer_skill->name}}' type="checkbox"
                        class="custom-control-input" id="customCheck{{$indexVal}}" @if (strpos($business_detail->skills,
                      $manufacturer_skill->name) !== false) checked @endif>
                      <label class="custom-control-label"
                        for="customCheck{{$indexVal}}">{{$manufacturer_skill->name}}</label>
                    </div>
                  </div>
