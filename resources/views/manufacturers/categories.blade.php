...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('manufacturers') }}">Manufacturers</a></li>
...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Add New Manufacturer Categories</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/manufacturers/category_store')}}" method="post"
                    class="parsley-examples" id="manufacturer_category_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="parent_id" class="control-label">Parent Manufacturer Category</label>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">Manufacturer Categories</h4>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-secondary custom-btn-1"
                                        href="{{ url('dashboard/manufacturers/category_edit',$category_data->id) }}">
