...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Become A Manufacturer</h4>
        </div>
                                    ...
                                    <ul class="nav nav-pills navtab-bg nav-justified" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link @if ($page_title == 'update-password') active @endif"
                                                ...
                                                aria-controls="contact" aria-selected="false">GSTIN Details</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div class="tab-pane fade active show " id="home" role="tabpanel"
                                            ...
                                            <div class="col-md-8" style="margin:0 auto;">
                                                <form enctype="multipart/form-data"
                                                    action="{{ url('dashboard/manufacturers/business-profile/business_submit/' . $id) }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="{{ $user->address }}" id="address"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name='work_in' class="form-control">
                                                                    <option value="wooden"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'wooden') selected @endif>
                                                                        Wooden</option>
                                                                    <option value="stone"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'stone') selected @endif>
                                                                        Stone</option>
                                                                    <option value="aluminium"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'aluminium') selected @endif>
                                                                        Aluminium</option>
                                                                    <option value="gifts item"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'gifts item') selected @endif>
                                                                        Gifts Item</option>
                                                                    <option value="iron"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'iron') selected @endif>
                                                                        Iron</option>
                                                                    <option value="antique items"
                                                                        @if (isset($business_detail->work_in) && $business_detail->work_in == 'antique items') selected @endif>
                                                                        Antique Items</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <!-- Col -->
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label for="ownership_type"
                                                                    class="control-label">Ownership type</label>
                                                                <select required="required" class="form-control"
                                                                    name="ownership_type" id="ownership_type">
                                                                    <option value="">Select Ownership</option>
                                                                    <option value="public limited company"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'public limited company') selected @endif>
                                                                        Public Limited Company</option>
                                                                    <option value="private limited company"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'private limited company') selected @endif>
                                                                        Private Limited Company</option>
                                                                    <option value="partnership"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'partnership') selected @endif>
                                                                        Partnership</option>
                                                                    <option value="proprietorship"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'proprietorship') selected @endif>
                                                                        Proprietorship</option>
                                                                    <option value="professional associations"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'professional associations') selected @endif>
                                                                        Professional Associations</option>
                                                                    <option value="limited liability partnership"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'limited liability partnership') selected @endif>
                                                                        Limited Liability Partnership (LLP)</option>
                                                                    <option value="other"
                                                                        @if (isset($business_detail->ownership_type) && $business_detail->ownership_type == 'other') selected @endif>
                                                                        Other</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-8" style="margin:0 auto;">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 text-center">
                                                        <div class="form-group">
                                                            @if ($business_detail && $business_detail->logo)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="15" name="about_company" id="about_company" class="form-control">{{ isset($business_detail->about_company) ? $business_detail->about_company : '' }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="{{ $user->facebook }}" parsley-type="url"
                                                                name="facebook" id="facebook" type="url"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="gts_number" class="control-label">GST
                                                                Number</label>
                                                            <input required="required" name="gts_number" id="gts_number"
                                                                type="text" class="form-control"
                                                                placeholder="Enter GTS Number"
                                                                value="{{ isset($business_detail->gts_number) ? $business_detail->gts_number : '' }}">
                                                        </div>
                                                    </div><!-- Col -->
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="gst_document" class="control-label">GST Detail
                                                                Document</label>
                                                            <input name="gst_document" id="gst_document"
                                                                value="{{ isset($business_detail->gst_document) ? $business_detail->gst_document : '' }}"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required="required"
                                                                value="{{ isset($business_detail->pan_number) ? $business_detail->pan_number : '' }}"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="tan_number" class="control-label">TAN
                                                                Number</label>
                                                            <input required="required"
                                                                value="{{ isset($business_detail->tan_number) ? $business_detail->tan_number : '' }}"
