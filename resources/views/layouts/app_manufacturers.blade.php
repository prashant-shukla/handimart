...
<head>
    ...
    <link rel="stylesheet" href="https://www.nobleui.com/html/template/assets/vendors/dropify/dist/dropify.min.css">
...
<body>
    <div id="app">
                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                <a href="{{ url('dashboard/manufacturers') }}" class="nav-link back-link">
                                    <i class="link-icon" data-feather="arrow-left-circle"></i>
                                    <span class="link-title">Back</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item {{ Route::is('manufacturers.my-profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/my-profile/' . $id) }}" class="nav-link ">
                        ...
                        <li class="nav-item {{ Route::is('manufacturers.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('manufacturers.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('manufacturers.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('manufacturers.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/my-profile/update-password/' . $id) }}"
                        ...
                        <li class="nav-item {{ request()->routeIs('manufacturers.business-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/business-profile/business-detail/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.business-detail') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="briefcase"></i>
                                <span class="link-title"> Business Detail </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('manufacturers.image-gallery') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/business-profile/image-gallery/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.image-gallery') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('manufacturers.promotional-video') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/business-profile/promotional-video/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.promotional-video') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="video"></i>
                                <span class="link-title"> Promotional Video </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('manufacturers.address') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/business-profile/address/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.address') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="map-pin"></i>
                                <span class="link-title"> Address </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->is('dashboard/manufacturers/jobs_a*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ request()->is('dashboard/manufacturers/jobs_a*') ? 'show' : '' }}"
                                id="jobs_a">
                                <ul class="nav sub-menu">
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/manufacturers/jobs_a/create/' . $id) }}"
                                            class="nav-link  {{ request()->routeIs('manufacturers.job_a_create') ? 'active' : '' }}">Add
                                            Requirement</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/manufacturers/jobs_a/' . $id) }}"
                                            class="nav-link {{ request()->routeIs('manufacturers.jobs_a') ? 'active' : '' }}">Manage
                                            Requirement</a>
                                    </li>
                                    <!-- <li class="nav-item ">
                      <a href="{{ url('dashboard/manufacturers/jobs_application/' . $id) }}" class="nav-link {{ request()->is('/manufacturers/jobs_application/*') ? 'active' : '' }}">Received Enquiry</a>
                    </li> -->
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('manufacturers.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('manufacturers.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/manufacturers/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('manufacturers.reviews') ? 'active' : '' }}">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown nav-messages">
                                ...
                                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                    ...
                                    <div class="dropdown-body">
                                        ...
                                        @if (isset($user_recent_chat) && count($user_recent_chat) > 0)
                                            @foreach ($user_recent_chat as $message_data)
                                                <a href="{{ url('dashboard/manufacturers/enquiries/' . $id . '/' . $message_data->contact_id) }}"
                                                    class="dropdown-item">
                                                    <div class="figure">
                                    ...
                                    <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                        <a href="{{ url('dashboard/manufacturers/enquiries/' . $id) }}">View all</a>
                                    </div>
                                </div>
                            </li>
        ...
        <!-- <script src="https://www.nobleui.com/html/template/assets/vendors/dropify/dist/dropify.min.js"></script> -->
        <!-- <script src="{{ asset('admin/assets/js/dropify.min.js') }}"></script>
        <script src="{{ asset('admin/assets/js/dropify.js') }}"></script> -->
        <!-- <script src="https://www.nobleui.com/html/template/assets/js/dropify.js"></script> -->
