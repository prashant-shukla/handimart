                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                <a href="{{ url('dashboard/designers') }}" class="nav-link back-link">
                                    <i class="link-icon" data-feather="arrow-left-circle"></i>
                                    <span class="link-title">Back</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item {{ Route::is('designers.my-profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/my-profile/' . $id) }}" class="nav-link ">
                                <i class="link-icon" data-feather="box"></i>
                                <span class="link-title">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Profile</li>
                        <li class="nav-item {{ Route::is('designers.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('designers.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('designers.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('designers.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/my-profile/update-password/' . $id) }}"
                        ...
                        <li class="nav-item {{ request()->routeIs('designers.business-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/business-profile/business-detail/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.business-detail') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="briefcase"></i>
                                <span class="link-title"> Business Detail </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('designers.image-gallery') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/business-profile/image-gallery/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.image-gallery') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="image"></i>
                                <span class="link-title"> Image Gallery </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->routeIs('designers.promotional-video') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/business-profile/promotional-video/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.promotional-video') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="video"></i>
                                <span class="link-title"> Promotional Video </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('designers.address') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/business-profile/address/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.address') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="map-pin"></i>
                                <span class="link-title"> Address </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->is('dashboard/designers/jobs_a*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ request()->is('dashboard/designers/jobs_a*') ? 'show' : '' }}"
                                id="jobs_a">
                                <ul class="nav sub-menu">
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/designers/jobs_a/create/' . $id) }}"
                                            class="nav-link  {{ request()->routeIs('designers.job_a_create') ? 'active' : '' }}">Add
                                            Requirement</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/designers/jobs_a/' . $id) }}"
                                            class="nav-link {{ request()->routeIs('designers.jobs_a') ? 'active' : '' }}">Manage
                                            Requirement</a>
                                    </li>
                                    <!-- <li class="nav-item ">
                      <a href="{{ url('dashboard/designers/jobs_application/' . $id) }}" class="nav-link {{ request()->is('/designers/jobs_application/*') ? 'active' : '' }}">Received Enquiry</a>
                    </li> -->
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('designers.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('designers.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/designers/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('designers.reviews') ? 'active' : '' }}">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown nav-messages">
                                ...
                                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                    ...
                                    <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                        <a href="{{ url('dashboard/designers/enquiries/' . $id) }}">View all</a>
                                    </div>
                                </div>
                            </li>
