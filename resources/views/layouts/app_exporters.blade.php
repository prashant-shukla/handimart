                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                <a href="{{ url('dashboard/exporters') }}" class="nav-link back-link">
                                    <i class="link-icon" data-feather="arrow-left-circle"></i>
                                    <span class="link-title">Back</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item {{ Route::is('exporters.my-profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/my-profile/' . $id) }}" class="nav-link ">
                        ...
                        <li class="nav-item {{ Route::is('exporters.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('exporters.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('exporters.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('exporters.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/my-profile/update-password/' . $id) }}"
                        ...
                        <li class="nav-item {{ request()->routeIs('exporters.business-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/business-profile/business-detail/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.business-detail') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="briefcase"></i>
                                <span class="link-title"> Business Detail </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('exporters.image-gallery') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/business-profile/image-gallery/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.image-gallery') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="image"></i>
                                <span class="link-title"> Image Gallery </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->routeIs('exporters.promotional-video') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/business-profile/promotional-video/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.promotional-video') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="video"></i>
                                <span class="link-title"> Promotional Video </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('exporters.address') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/business-profile/address/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.address') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="map-pin"></i>
                                <span class="link-title"> Address </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->is('dashboard/exporters/jobs_a*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ request()->is('dashboard/exporters/jobs_a*') ? 'show' : '' }}"
                                id="jobs_a">
                                <ul class="nav sub-menu">
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/exporters/jobs_a/create/' . $id) }}"
                                            class="nav-link  {{ request()->routeIs('exporters.job_a_create') ? 'active' : '' }}">Add
                                            Requirement</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/exporters/jobs_a/' . $id) }}"
                                            class="nav-link {{ request()->routeIs('exporters.jobs_a') ? 'active' : '' }}">Manage
                                            Requirement</a>
                                    </li>
                                    <!-- <li class="nav-item ">
                                    <a href="{{ url('dashboard/exporters/jobs_application/' . $id) }}" class="nav-link {{ request()->is('/exporters/jobs_application/*') ? 'active' : '' }}">Received Enquiry</a>
                                    </li> -->
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('exporters.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('exporters.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/exporters/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('exporters.reviews') ? 'active' : '' }}">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown nav-messages">
                                ...
                                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                    ...
                                    <div class="dropdown-body">
                                        ...
                                        @if (isset($user_recent_chat) && count($user_recent_chat) > 0)
                                            @foreach ($user_recent_chat as $message_data)
                                                <a href="{{ url('dashboard/exporters/enquiries/' . $id . '/' . $message_data->contact_id) }}"
                                                    class="dropdown-item">
                                                    <div class="figure">
                                    ...
                                    <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                        <a href="{{ url('dashboard/exporters/enquiries/' . $id) }}">View all</a>
                                    </div>
                                </div>
                            </li>
