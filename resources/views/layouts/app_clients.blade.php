            ...
            <nav class="sidebar">
                <div class="sidebar-header">
                    <a href="{{ url('') }}" class="sidebar-brand">
                        <img src="{{ asset('admin/assets/images/logo-dark.png') }}" style="width: 86%;">
                    </a>
                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                ...
                                <a href="{{ url('dashboard/users') }}" class="nav-link back-link">
                        ...
                        <li class="nav-item {{ Route::is('clients.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('clients.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('clients.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('clients.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/my-profile/update-password/' . $id) }}"
                        ...
                        <li class="nav-item {{ request()->routeIs('clients.business-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/business-profile/start-service/' . $id) }}"
                                class="nav-link {{ request()->routeIs('clients.business-detail') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="briefcase"></i>
                                <span class="link-title"> Start Servise Now </span>
                            </a>
                        </li>

                        <li class="nav-item nav-category">Enquiries</li>
                        <li class="nav-item {{ request()->routeIs('clients.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('clients.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('clients.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/clients/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('clients.reviews') ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown nav-apps">
                            ...
                            <li class="nav-item dropdown nav-messages">
                                ...
                                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                    ...
                                    <div class="dropdown-body">
                                        ...
                                        @if (isset($user_recent_chat) && count($user_recent_chat) > 0)
                                            @foreach ($user_recent_chat as $message_data)
                                                <a href="{{ url('dashboard/clients/enquiries/' . $id . '/' . $message_data->contact_id) }}"
                                                    class="dropdown-item">
                                                    <div class="figure">
                                    ...
                                    <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                        <a href="{{ url('dashboard/clients/enquiries/' . $id) }}">View all</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item dropdown nav-profile">
                                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown"
                                    role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <img style="border: 1px solid #5BBB7B; margin-right:10px"
                                        src="{{ get_user_profile_pic($id) }}" alt="profile">My
                                    Profile
                                </a>
