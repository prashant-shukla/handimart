                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                <a href="{{ url('dashboard/photographers') }}" class="nav-link back-link">
                                    <i class="link-icon" data-feather="arrow-left-circle"></i>
                                    <span class="link-title">Back</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item {{ Route::is('photographers.my-profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/my-profile/' . $id) }}" class="nav-link ">
                        ...
                        <li class="nav-item {{ Route::is('photographers.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('photographers.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('photographers.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('photographers.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/my-profile/update-password/' . $id) }}"
                        ...
                        <li class="nav-item {{ request()->routeIs('photographers.business-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/business-profile/business-detail/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.business-detail') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="briefcase"></i>
                                <span class="link-title"> Business Detail </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('photographers.image-gallery') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/business-profile/image-gallery/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.image-gallery') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('photographers.promotional-video') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/business-profile/promotional-video/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.promotional-video') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="video"></i>
                                <span class="link-title"> Promotional Video </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('photographers.address') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/business-profile/address/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.address') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="map-pin"></i>
                                <span class="link-title"> Address </span>
                            </a>
                        </li>

                        <li class="nav-item {{ request()->is('dashboard/photographers/jobs_a*') ? 'active' : '' }}">
                            ...
                            <div class="collapse {{ request()->is('dashboard/photographers/jobs_a*') ? 'show' : '' }}"
                                id="jobs_a">
                                <ul class="nav sub-menu">
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/photographers/jobs_a/create/' . $id) }}"
                                            class="nav-link  {{ request()->routeIs('photographers.job_a_create') ? 'active' : '' }}">Add
                                            Requirement</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('dashboard/photographers/jobs_a/' . $id) }}"
                                            class="nav-link {{ request()->routeIs('photographers.jobs_a') ? 'active' : '' }}">Manage
                                            Requirement</a>
                                    </li>
                                    <!-- <li class="nav-item ">
                                    <a href="{{ url('dashboard/photographers/jobs_application/' . $id) }}" class="nav-link {{ request()->is('/photographers/jobs_application/*') ? 'active' : '' }}">Received Enquiry</a>
                                    </li> -->
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item {{ request()->routeIs('photographers.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('photographers.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/photographers/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('photographers.reviews') ? 'active' : '' }}">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown nav-messages">
                                ...
                                <div class="dropdown-menu" aria-labelledby="messageDropdown">
                                    ...
                                    <div class="dropdown-body">
                                        ...
                                        @if (isset($user_recent_chat) && count($user_recent_chat) > 0)
                                            @foreach ($user_recent_chat as $message_data)
                                                <a href="{{ url('dashboard/photographers/enquiries/' . $id . '/' . $message_data->contact_id) }}"
                                                    class="dropdown-item">
                                                    <div class="figure">
                                    ...
                                    <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                        <a href="{{ url('dashboard/photographers/enquiries/' . $id) }}">View all</a>
                                    </div>
                                </div>
                            </li>
