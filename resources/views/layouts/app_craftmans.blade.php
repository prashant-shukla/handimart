                    ...
                    <ul class="nav bg">
                        ...
                        @if (Auth::user()->role_id == '1')
                            <li class="nav-item {{ active_class(['dashboard']) }}">
                                <a href="{{ url('dashboard/craftmans') }}" class="nav-link back-link">
                                    <i class="link-icon" data-feather="arrow-left-circle"></i>
                                    <span class="link-title">Back</span>
                                </a>
                            </li>
                        @endif
                        <li class="nav-item {{ Route::is('craftmans.my-profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/my-profile/' . $id) }}" class="nav-link ">
                        ...
                        <li class="nav-item {{ Route::is('craftmans.profile') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/my-profile/profile/' . $id) }}"
                                class="bg nav-link {{ active_class(['my-profile/profile']) }}">
                                <i class="link-icon" data-feather="user"></i>
                                <span class="link-title">My Profile</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('craftmans.personal-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/my-profile/personal-detail/' . $id) }}"
                        ...
                        <li class="nav-item {{ Route::is('craftmans.social-detail') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/my-profile/social-detail/' . $id) }}"
                                class="nav-link {{ active_class(['my-profile/social-detail']) }}">
                                <i class="link-icon" data-feather="users"></i>
                                <span class="link-title">Social-Details</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('craftmans.update-password') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/my-profile/update-password/' . $id) }}"
                        ...
                        @if (session('ROLE_STATUS') != 2)
                            <li class="nav-item nav-category">Start Service</li>
                            <li class="nav-item {{ request()->routeIs('craftmans.business-detail') ? 'active' : '' }}">
                                <a href="{{ url('dashboard/craftmans/business-profile/business-detail/' . $id) }}"
                                    class="nav-link {{ request()->routeIs('craftmans.business-detail') ? 'active' : '' }}">
                                    <i class="link-icon" data-feather="briefcase"></i>
                                    <span class="link-title"> Business Detail </span>
                                </a>
                            </li>
                            <li class="nav-item {{ request()->routeIs('craftmans.image-gallery') ? 'active' : '' }}">
                                <a href="{{ url('dashboard/craftmans/business-profile/image-gallery/' . $id) }}"
                                    class="nav-link {{ request()->routeIs('craftmans.image-gallery') ? 'active' : '' }}">
                                    <i class="link-icon" data-feather="image"></i>
                                    <span class="link-title"> Image Gallery </span>
                                </a>
                            </li>
                            @if (session('ROLE_STATUS') == 3)
                                <li class="nav-item {{ active_class(['business-profile/product-gallery']) }}">
                                    <a href="{{ url('dashboard/business-profile/product-gallery') }}"
                                        class="nav-link {{ active_class(['business-profile/product-gallery']) }}">
                                        <i class="link-icon" data-feather="grid"></i>
                                        <span class="link-title"> Product Gallery </span>
                                    </a>
                                </li>
                            @endif
                            <li
                                class="nav-item {{ request()->routeIs('craftmans.promotional-video') ? 'active' : '' }}">
                                <a href="{{ url('dashboard/craftmans/business-profile/promotional-video/' . $id) }}"
                                    class="nav-link {{ request()->routeIs('craftmans.promotional-video') ? 'active' : '' }}">
                                    <i class="link-icon" data-feather="video"></i>
                                    <span class="link-title"> Promotional Video </span>
                                </a>
                            </li>
                            <li class="nav-item {{ request()->routeIs('craftmans.address') ? 'active' : '' }}">
                                <a href="{{ url('dashboard/craftmans/business-profile/address/' . $id) }}"
                                    class="nav-link {{ request()->routeIs('craftmans.address') ? 'active' : '' }}">
                                    <i class="link-icon" data-feather="map-pin"></i>
                                    <span class="link-title"> Address </span>
                                </a>
                            </li>
                            <!-- <li class="nav-item {{ active_class(['craftmans/jobs/']) }}">
              <a href="{{ url('dashboard/craftmans/jobs/' . $id) }}" class="nav-link {{ active_class(['craftmans/jobs']) }}">
                <i class="link-icon" data-feather="briefcase"></i>
                <span class="link-title"> Jobs </span>
              </a>
            </li> -->
                            <!-- <li class="nav-item {{ active_class(['craftmans/jobs/']) }}">
                <a class="nav-link" data-toggle="collapse" href="#jobs" role="button" aria-expanded="false" aria-controls="jobs">
                  <i class="link-icon" data-feather="briefcase"></i>
                  <span class="link-title">Jobs</span>
                ...
                <div class="collapse" id="jobs">
                  <ul class="nav sub-menu">
                    <li class="nav-item">
                      <a href="{{ url('dashboard/craftmans/jobs/' . $id) }}" class="nav-link {{ active_class(['craftmans/jobs']) }}">Job Listing</a>
                    </li>
                    <li class="nav-item">
                      <a href="{{ url('dashboard/craftmans/jobs/create/' . $id) }}" class="nav-link">Add Job</a>
                    </li>
                    <li class="nav-item">
                      <a href="{{ url('dashboard/craftmans/finished-jobs/' . $id) }}" class="nav-link {{ active_class(['craftmans/finished-jobs']) }}">Job Listing</a>
                    </li>
                  </ul>
                </div>
            </li> -->
                            ...
                            <li class="nav-item {{ request()->is('dashboard/craftmans/jobs_a*') ? 'active' : '' }}">
                                ...
                                <div class="collapse {{ request()->is('dashboard/craftmans/jobs_a*') ? 'show' : '' }}"
                                    id="jobs_a">
                                    <ul class="nav sub-menu">
                                        <li class="nav-item">
                                            <a href="{{ url('dashboard/craftmans/jobs_a/create/' . $id) }}"
                                                class="nav-link  {{ request()->routeIs('craftmans.job_a_create') ? 'active' : '' }}">Add
                                                Requirement</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ url('dashboard/craftmans/jobs_a/' . $id) }}"
                                                class="nav-link {{ request()->routeIs('craftmans.jobs_a') ? 'active' : '' }}">Manage
                                                Requirement</a>
                                        </li>
                                        <!-- <li class="nav-item ">
                      <a href="{{ url('dashboard/craftmans/jobs_application/' . $id) }}" class="nav-link {{ request()->is('/craftmans/jobs_application/*') ? 'active' : '' }}">Received Enquiry</a>
                    </li> -->
                                    </ul>
                                </div>
                            </li>
                        @else
                            <li class="nav-item nav-category">Become A Service Provider</li>
                            <li class="nav-item {{ active_class(['Add-business/business-detail']) }}">
                                <a href="{{ url('dashboard/Add-business/business-detail') }}"
                                    class="nav-link {{ active_class(['Add-business/business-detail']) }}">
                                    <i class="link-icon" data-feather="briefcase"></i>
                                    <span class="link-title">Add Business Detail </span>
                                </a>
                            </li>
                        @endif

                        <li class="nav-item nav-category">Enquiries</li>
                        <li class="nav-item {{ request()->routeIs('craftmans.enquiries') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/enquiries/' . $id) }}"
                                class="nav-link {{ request()->routeIs('craftmans.enquiries') ? 'active' : '' }}">
                                <i class="link-icon" data-feather="mail"></i>
                                <span class="link-title">Enquiries</span>
                            </a>
                        </li>
                        <li class="nav-item nav-category">Reviews</li>
                        <li class="nav-item {{ request()->routeIs('craftmans.reviews') ? 'active' : '' }}">
                            <a href="{{ url('dashboard/craftmans/reviews/' . $id) }}"
                                class="nav-link {{ request()->routeIs('craftmans.reviews') ? 'active' : '' }}">
                                    ...
                                    <div class="dropdown-body">
                                        ...
                                        @if (isset($user_recent_chat) && count($user_recent_chat) > 0)
                                            @foreach ($user_recent_chat as $message_data)
                                                <a href="{{ url('dashboard/craftmans/enquiries/' . $id . '/' . $message_data->contact_id) }}"
                                                    class="dropdown-item">
                                                    <div class="figure">
                                        ...
                                        <div class="dropdown-footer d-flex align-items-center justify-content-center">
                                            <a href="{{ url('dashboard/craftmans/enquiries/' . $id) }}">View all</a>
                                        </div>
                                    </div>
                            </li>
