...
<form enctype="multipart/form-data" action="{{url('dashboard/painters/jobs/job_update/'.$id.'/'.$user_id)}}" method="post" id="job_create_form" enctype="multipart/form-data" >
    @csrf
<div class="row ">
                        ...
                        <div class="card-body">
                            ...
                            @foreach($job_images as $images)
                                ...
                                <img src="{{ $images->image_thumb_path }}" style="height: 140px" class="image card-img-top" alt="...">
                                    <div class="middle">
                                    <div class="text">
                                        <a href="{{url('dashboard/painters/jobs/image_delete/'.$images->id.'/'.$user_id)}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Image">
