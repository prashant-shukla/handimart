...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('painters.categories') }}">Categories</a></li>
...
<div class="row">
    <div class="col-md-5 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 mb-md-0">Update Painter Categories</h4>
                <hr class="mt-2">
                <form action="{{url('dashboard/painters/category_update/'.$id)}}" method="post"
                    class="parsley-examples" id="painter_category_form">
                    @csrf
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="parent_id" class="control-label">Parent Painter Category</label>
