...
class DesignerController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            if($this->user->role_id != '5' && $this->user->role_id != '1'){
    ...
    public function index(Request $request)
    {
        ...
        $user_list = User::where('role_id','5')->where('new_added','0')->orderBy('id','DESC')->get();
        ...
        return view('designers.index',compact('user_list'))
    ...
    public function new(Request $request)
    {
        ...
        $user_list = User::where('role_id','5')->where('new_added','1')->orderBy('id','DESC')->get();
        foreach ($user_list as $value) {
            if($value->image != '' && file_exists(public_path('uploads/users/').$value->image)){
                $value->image_thumb_path = asset('public/uploads/users/thumb/').'/'.$value->image;
            } else {
    ...
    {
        $this->layout = View::make('layouts.app_designers');
        $roles = Role::pluck('name','name')->all();
        return view('designers.create',compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('designers.new')
    ...
    public function categories(Request $request)
    {
        ...
        $categories_list = DesignerCategory::all();
        $parent_categories = DesignerCategory::where('parent_id', '0')->get();
        return view('designers.categories',compact('categories_list','parent_categories'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function category_store(Request $request)
    {
        ...
        $input['slug'] = $slug;
        $category = DesignerCategory::create($input);

        return redirect()->route('designers.categories')
    ...
    public function category_edit(Request $request, $id)
    {
        ...
        $caegories_data = DesignerCategory::find($id);
        $parent_categories = DesignerCategory::where('parent_id', '0')->where('id', '!=', $id)->get();
        if(!isset($caegories_data)) {
            return redirect()->route('designers.categories')
            ->with('warning','Category not found');
        }

        return view('designers.category_edit',compact('caegories_data','id','parent_categories'));
    }
    ...
    {
        $skills_list = DesignerSkill::all();
        return view('designers.skills',compact('skills_list'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function skill_store(Request $request)
    {
        ...
        $input = $request->all();
        $skill = DesignerSkill::create($input);

        return redirect()->route('designers.skills')
                        ->with('success','Skill created successfully');
    }

    public function skill_edit(Request $request, $id)
    {
        $skill_data = DesignerSkill::find($id);
        ...
        return view('designers.skill_edit',compact('skill_data','id'));
    }
    ...
    public function profile($id,$user_id = 0)
    {
        ...
        return view('designers.show',compact('user','roles','userRole','id','user_id','page_title','countries','states','cities','image_gallery','business_detail'));
    }
    ...
    public function dashboard($id)
    {
        ...
        return view('designers.dashboard',compact('user','id','total_reviews','total_jobs','total_contacts','all_messages','job_listing'));
    }
    /**
    ...
    public function personal_detail($id)
    {
        ...
        $states = State::where('country_id',$user->country_id)->orderBy('name', 'ASC')->get();
        $cities = City::where('state_id',$user->state)->orderBy('name', 'ASC')->get();
        return view('designers.edit',compact('user','roles','userRole','id','page_title','countries','states','cities'));
    }
    ...
    public function update_password($id)
    {
        ...
        return view('designers.edit',compact('user','roles','userRole','id','page_title'));
    }
    ...
    public function personal_submit(Request $request, $id)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('designers')
            ->with('warning','Designer not found');
        }
        ...
        return redirect()->route('designers.personal-detail',$id)
    ...
    public function social_submit(Request $request, $id)
    {
        ...
        return redirect()->route('designers.personal-detail',$id)
                        ->with('success','Designer social detail updated successfully');
    }
    ...
    public function password_submit(Request $request, $id)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('designers')
            ->with('warning','Designers not found');
        }
        ...
        return redirect()->route('designers.personal-detail',$id)
                        ->with('success','Designers password updated successfully');
    }
    ...
    public function business_detail($id)
    {
        ...
        $designer_categories = DesignerCategory::all();
        $designer_skills = DesignerSkill::all();
        $roles = Role::pluck('name','name')->all();
        $userRole = $user->roles->pluck('name','name')->all();
        
        $business_detail = BusinessDetails::where('user_id',$id)->first();

        return view('designers.business_details',compact('user','roles','userRole','id','page_title','business_detail','designer_categories','designer_skills'));
    }
    ...
    public function image_gallery($id)
    {
        ...
        return view('designers.image-gallery',compact('result','id','page_title','user'));
    }
    ...
    function promotional_video($id){
    	...
    	return view('designers.promotional-video',compact('result','id','page_title','user'));
    }
    ...
    public function address($id)
    {
        ...
        return view('designers.address',compact('id','page_title','user'));
    }
    ...
    public function jobs($id)
    {
        ...
        return view('designers.jobs',compact('id','job_listing'));
    }
    ...
    public function job_create($id)
    {
        ...
        return view('designers.job_create',compact('id','job_categories'));
    }
    ...
    public function job_store(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('designers.jobs',[$id])
    ...
    public function job_edit($id, $user_id)
    {
        ...
        if(!isset($job_data)) {
            return redirect()->route('designers.jobs',$user_id)
        ...
        return view('designers.job_edit',compact('id','user_id','job_categories','job_data','job_images'));
    }
    ...
    public function job_image_destroy($image_id, $id)
    {
        ...
        $job_image->delete();
        return redirect()->route('designers.job_preview', ['job_id' => $job_id, 'id' => $id] )
    ...
    public function job_image_destroy_edit($image_id, $id)
    {
        ...
        $job_id = $job_image->job_id;
        $job_image->delete();
        return redirect()->route('designers.job_a_edit', ['job_id' => $job_id, 'id' => $id] )
                            ->with('success','Job deleted successfully');
    }
    ...
    public function jobs_a($id)
    {
        ...
        return view('designers.jobs_a',compact('id','job_listing'));
    }
    ...
    public function job_a_create($id)
    {
        ...
        return view('designers.job_a_create',compact('id','job_categories','job_types'));
    }
    ...
    public function job_store_a(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('designers.job_preview',[$job_id,$id]);
    }
    ...
    public function job_preview($job_id, $id)
    {
        ...
        if(!isset($jobs)) {
            return redirect()->route('designers.jobs_a',$user_id)
            ->with('warning','Job not found');
        }
        ...
        return view('designers.job_preview',compact('job_id','id','job_categories','job_types','jobs','job_images','user_data'));
    }
    ...
    public function job_a_edit($job_id, $id)
    {
        ...
        return view('designers.job_a_edit',compact('job_id','id','job_categories','job_types','job_data','job_images'));
    }
    ...
    public function job_post($job_id, $id)
    {
        ...
        $input['previewed'] = 1;
        $jobs->update($input);
        return redirect()->route('designers.jobs_a',[$id])->with('success','Requirement posted successfully');
    }
    ...
    public function job_a_destroy($id, $job_id)
    {
        $job = Job::find($job_id);
        if(!isset($job)) {
            return redirect()->route('designers.jobs_a',$id)
            ->with('warning','Job not found');
        }
        $job->delete();
        return redirect()->route('designers.jobs_a',$id)
    ...
    public function reviews($id)
    {
        ...
        return view('designers.reviews',compact('id','received_reviews','sent_reviews'));
    }
    ...
    public function delete_review($review_id, $id) {
        ...
        // return redirect()->route('designers.reviews',$id)->with('success','Review deleted successfully');
    }
    // Reviews Section end
    ...
    public function enquiries($id,$enq_id=0)
    {
        ...
        return view('designers.enquiries',compact('id','enq_id','user_details','contact_list','all_messages','messages_list','messages_user_data_all','added_contact'));
    }
    ...
    public function start_chat($id,$room_user_id)
    {
        ...
        return redirect()->route('designers.enquiries',[$id,$enq_id]);
                        ...
                        <div class="d-flex align-items-center aasdiv">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                                ...
                                <div class="d-flex align-items-end text-body">
                                    <a
                                        href="'.url("dashboard/designers/enquiries/start_chat/".$id."/".$user_data->id).'">
                                    ...
                                    <a
                                        href="'.url("dashboard/designers/enquiries/save_contact/".$id."/".$user_data->id."/".$enq_id).'">
    ...
    public function delete_enquiry($enquiry_id, $id) {
        ...
        return redirect()->route('designers.enquiries',$id)
