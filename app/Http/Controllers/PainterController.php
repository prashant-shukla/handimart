...
use App\PainterCategory;
use App\PainterSkill;
use DB;
use Hash;
use View;
use Auth;
...
class PainterController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            if($this->user->role_id != '6' && $this->user->role_id != '1'){
    ...
    public function index(Request $request)
    {
        ...
        $user_list = User::where('role_id','6')->where('new_added','0')->orderBy('id','DESC')->get();
        ...
        return view('painters.index',compact('user_list'))
    ...
    public function new(Request $request)
    {
        ...
        $user_list = User::where('role_id','6')->where('new_added','1')->orderBy('id','DESC')->get();
        foreach ($user_list as $value) {
            if($value->image != '' && file_exists(public_path('uploads/users/').$value->image)){
                $value->image_thumb_path = asset('public/uploads/users/thumb/').'/'.$value->image;
            } else {
    ...
    public function create()
    {
        ...
        $this->layout = View::make('layouts.app_painters');
        $roles = Role::pluck('name','name')->all();
        return view('painters.create',compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('painters.new')
                        ->with('success','Painter created successfully');
    }
    ...
    public function categories(Request $request)
    {
        ...
        $categories_list = PainterCategory::all();
        $parent_categories = PainterCategory::where('parent_id', '0')->get();
        return view('painters.categories',compact('categories_list','parent_categories'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function category_store(Request $request)
    {
        ...
        $input['slug'] = $slug;
        $category = PainterCategory::create($input);

        return redirect()->route('painters.categories')
    ...
    public function category_edit(Request $request, $id)
    {
        ...
        $caegories_data = PainterCategory::find($id);
        $parent_categories = PainterCategory::where('parent_id', '0')->where('id', '!=', $id)->get();
        if(!isset($caegories_data)) {
            return redirect()->route('painters.categories')
            ->with('warning','Category not found');
        }

        return view('painters.category_edit',compact('caegories_data','id','parent_categories'));
    }
    ...
    public function skills(Request $request)
    {
        ...
        $skills_list = PainterSkill::all();
        return view('painters.skills',compact('skills_list'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function skill_store(Request $request)
    {
        ...
        $input = $request->all();
        $skill = PainterSkill::create($input);

        return redirect()->route('painters.skills')
    ...
    public function skill_edit(Request $request, $id)
    {
        ...
        $skill_data = PainterSkill::find($id);
        ...
        return view('painters.skill_edit',compact('skill_data','id'));
    }
    ...
    public function profile($id,$user_id = 0)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('painters')
        ...
        return view('painters.show',compact('user','roles','userRole','id','user_id','page_title','countries','states','cities','image_gallery','business_detail'));
    }
    ...
    public function dashboard($id)
    {
        ...
        return view('painters.dashboard',compact('user','id','total_reviews','total_jobs','total_contacts','all_messages','job_listing'));
    }
    ...
    public function personal_detail($id)
    {
        ...
        $states = State::where('country_id',$user->country_id)->orderBy('name', 'ASC')->get();
        $cities = City::where('state_id',$user->state)->orderBy('name', 'ASC')->get();
        return view('painters.edit',compact('user','roles','userRole','id','page_title','countries','states','cities'));
    }
    ...
    public function update_password($id)
    {
        ...
        return view('painters.edit',compact('user','roles','userRole','id','page_title'));
    }
    ...
    public function personal_submit(Request $request, $id)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('painters')
            ->with('warning','Painters not found');
        }
        ...
        $user->update($input);
        return redirect()->route('painters.personal-detail',$id)
                        ->with('success','Painters updated successfully');
    }
    ...
    public function social_submit(Request $request, $id)
    {
        ...
        return redirect()->route('painters.personal-detail',$id)
                        ->with('success','Painters social detail updated successfully');
    }
    ...
    public function password_submit(Request $request, $id)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('painters')
            ->with('warning','Painter not found');
        }
        ...
        return redirect()->route('painters.personal-detail',$id)
                        ->with('success','Painters password updated successfully');
    }
    ...
    public function business_detail($id)
    {
        ...
        $painter_categories = PainterCategory::all();
        $painter_skills = PainterSkill::all();
        $roles = Role::pluck('name','name')->all();
        $userRole = $user->roles->pluck('name','name')->all();
        
        $business_detail = BusinessDetails::where('user_id',$id)->first();

        return view('painters.business_details',compact('user','roles','userRole','id','page_title','business_detail','painter_categories','painter_skills'));
    }
    ...
    public function image_gallery($id)
    {
        ...
        return view('painters.image-gallery',compact('result','id','page_title','user'));
    }
    ...
    function promotional_video($id){
    	...
    	return view('painters.promotional-video',compact('result','id','page_title','user'));
    }
    ...
    public function address($id)
    {
        ...
        return view('painters.address',compact('id','page_title','user'));
    }
    ...
    public function jobs($id)
    {
        ...
        return view('painters.jobs',compact('id','job_listing'));
    }
    ...
    public function job_create($id)
    {
        ...
        return view('painters.job_create',compact('id','job_categories'));
    }
    ...
    public function job_store(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('painters.jobs',[$id])
    ...
    public function job_edit($id, $user_id)
    {
        ...
        if(!isset($job_data)) {
            return redirect()->route('painters.jobs',$user_id)
        ...
        return view('painters.job_edit',compact('id','user_id','job_categories','job_data','job_images'));
    }
    ...
    public function job_image_destroy($image_id, $id)
    {
        ...
        $job_image->delete();
        return redirect()->route('painters.job_preview', ['job_id' => $job_id, 'id' => $id] )
    ...
    public function job_image_destroy_edit($image_id, $id)
    {
        ...
        $job_id = $job_image->job_id;
        $job_image->delete();
        return redirect()->route('painters.job_a_edit', ['job_id' => $job_id, 'id' => $id] )
                            ->with('success','Job deleted successfully');
    }
    ...
    public function jobs_a($id)
    {
        ...
        return view('painters.jobs_a',compact('id','job_listing'));
    }
    ...
    public function job_a_create($id)
    {
        ...
        return view('painters.job_a_create',compact('id','job_categories','job_types'));
    }
    ...
    public function job_store_a(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('painters.job_preview',[$job_id,$id]);
    }
    ...
    public function job_preview($job_id, $id)
    {
        ...
        if(!isset($jobs)) {
            return redirect()->route('painters.jobs_a',$user_id)
            ->with('warning','Job not found');
        }
        ...
        return view('painters.job_preview',compact('job_id','id','job_categories','job_types','jobs','job_images','user_data'));
    }
    ...
    public function job_a_edit($job_id, $id)
    {
        ...
        return view('painters.job_a_edit',compact('job_id','id','job_categories','job_types','job_data','job_images'));
    }
    ...
    public function job_post($job_id, $id)
    {
        ...
        $input['previewed'] = 1;
        $jobs->update($input);
        return redirect()->route('painters.jobs_a',[$id])->with('success','Requirement posted successfully');
    }
    ...
    public function job_a_destroy($id, $job_id)
    {
        $job = Job::find($job_id);
        if(!isset($job)) {
            return redirect()->route('painters.jobs_a',$id)
            ->with('warning','Job not found');
        }
        $job->delete();
        return redirect()->route('painters.jobs_a',$id)
    ...
    public function reviews($id)
    {
        ...
        return view('painters.reviews',compact('id','received_reviews','sent_reviews'));
    }
    ...
    public function delete_review($review_id, $id) {
        ...
        // return redirect()->route('painters.reviews',$id)->with('success','Review deleted successfully');
    }
    // Reviews Section end
    ...
    public function enquiries($id,$enq_id=0)
    {
        ...
        return view('painters.enquiries',compact('id','enq_id','user_details','contact_list','all_messages','messages_list','messages_user_data_all','added_contact'));
    }
    ...
    public function start_chat($id,$room_user_id)
    {
        ...
        return redirect()->route('painters.enquiries',[$id,$enq_id]);
                        ...
                        <div class="d-flex align-items-center aasdiv">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                                ...
                                <div class="d-flex align-items-end text-body">
                                    <a
                                        href="'.url("dashboard/painters/enquiries/start_chat/".$id."/".$user_data->id).'">
                                    ...
                                    <a
                                        href="'.url("dashboard/painters/enquiries/save_contact/".$id."/".$user_data->id."/".$enq_id).'">
    ...
    public function delete_enquiry($enquiry_id, $id) {
        ...
        return redirect()->route('painters.enquiries',$id)
    ...
    public function destroy($id)
    {
        ...
        $user->delete();
        return redirect()->route('painters')
                            ->with('success','Painter deleted successfully');
