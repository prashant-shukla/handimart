...
use App\ManufacturerCategory;
use App\ManufacturerSkill;
use DB;
use Hash;
use View;
use Auth;
...
class ManufacturerController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next) {
            ...
            if($this->user->role_id != '3' && $this->user->role_id != '1'){
    ...
    public function index(Request $request)
    {
        ...
        $user_list = User::where('role_id','3')->where('new_added','0')->orderBy('id','DESC')->get();
        ...
        return view('manufacturers.index',compact('user_list'))
    ...
    public function new(Request $request)
    {
        ...
        $user_list = User::where('role_id','3')->where('new_added','1')->orderBy('id','DESC')->get();
        foreach ($user_list as $value) {
            if($value->image != '' && file_exists(public_path('uploads/users/').$value->image)){
                $value->image_thumb_path = asset('public/uploads/users/thumb/').'/'.$value->image;
            } else {
    ...
    public function create()
    {
        ...
        $this->layout = View::make('layouts.app_manufacturers');
        $roles = Role::pluck('name','name')->all();
        return view('manufacturers.create',compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manufacturers.new')
    ...
    public function categories(Request $request)
    {
        ...
        $categories_list = ManufacturerCategory::all();
        $parent_categories = ManufacturerCategory::where('parent_id', '0')->get();
        return view('manufacturers.categories',compact('categories_list','parent_categories'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function category_store(Request $request)
    {
        ...
        $input['slug'] = $slug;
        $category = ManufacturerCategory::create($input);

        return redirect()->route('manufacturers.categories')
    ...
    public function category_edit(Request $request, $id)
    {
        ...
        $caegories_data = ManufacturerCategory::find($id);
        $parent_categories = ManufacturerCategory::where('parent_id', '0')->where('id', '!=', $id)->get();
        if(!isset($caegories_data)) {
            return redirect()->route('manufacturers.categories')
            ->with('warning','Category not found');
        }

        return view('manufacturers.category_edit',compact('caegories_data','id','parent_categories'));
    }
    ...
    public function skills(Request $request)
    {
        ...
        $skills_list = ManufacturerSkill::all();
        return view('manufacturers.skills',compact('skills_list'))
            ->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function skill_store(Request $request)
    {
        ...
        $input = $request->all();
        $skill = ManufacturerSkill::create($input);

        return redirect()->route('manufacturers.skills')
    ...
    public function skill_edit(Request $request, $id)
    {
        ...
        $skill_data = ManufacturerSkill::find($id);
        if(!isset($skill_data)) {
            return redirect()->route('manufacturers.skills')
            ->with('warning','Skill data not found');
        }

        return view('manufacturers.skill_edit',compact('skill_data','id'));
    }
    ...
    public function profile($id,$user_id = 0)
    {
        ...
        return view('manufacturers.show',compact('user','roles','userRole','id','user_id','page_title','countries','states','cities','image_gallery','business_detail'));
    }
    ...
    public function dashboard($id)
    {
        ...
        return view('manufacturers.dashboard',compact('user','id','total_reviews','total_jobs','total_contacts','all_messages','job_listing'));
    }
    ...
    public function personal_detail($id)
    {
        ...
        $states = State::where('country_id',$user->country_id)->orderBy('name', 'ASC')->get();
        $cities = City::where('state_id',$user->state)->orderBy('name', 'ASC')->get();
        return view('manufacturers.edit',compact('user','roles','userRole','id','page_title','countries','states','cities'));
    }
    ...
    public function update_password($id)
    {
        ...
        return view('manufacturers.edit',compact('user','roles','userRole','id','page_title'));
    }
    ...
    public function personal_submit(Request $request, $id)
    {
        ...
        if(!isset($user)) {
            return redirect()->route('manufacturers')
            ->with('warning','Manufacturer not found');
        }
        ...
        return redirect()->route('manufacturers.personal-detail',$id)
    ...
    public function social_submit(Request $request, $id)
    {
        ...
        return redirect()->route('manufacturers.personal-detail',$id)
                        ->with('success','Manufacturers social detail updated successfully');
    }
    ...
    public function password_submit(Request $request, $id)
    {
        ...
        return redirect()->route('manufacturers.personal-detail',$id)
                        ->with('success','Manufacturer password updated successfully');
    }
    ...
    public function business_detail($id)
    {
        ...
        $manufacturer_categories = ManufacturerCategory::all();
        $manufacturer_skills = ManufacturerSkill::all();
        $roles = Role::pluck('name','name')->all();
        $userRole = $user->roles->pluck('name','name')->all();
        ...
        return view('manufacturers.business_details',compact('user','roles','userRole','id','page_title','business_detail','manufacturer_categories','manufacturer_skills','countries','states','cities'));
    }
    ...
    public function business_submit(Request $request, $id)
    {
        ...
        if(isset($request->logo)) {
            ...
            $thumb = Image::make($request->logo->getRealPath())->resize(200, 200, function ($constraint) {
                $constraint->aspectRatio(); //maintain image ratio
            });
    ...
    public function image_gallery($id)
    {
        ...
        return view('manufacturers.image-gallery',compact('result','id','page_title','user'));
    }
    ...
    function promotional_video($id){
    	...
    	return view('manufacturers.promotional-video',compact('result','id','page_title','user'));
    }
    ...
    public function address($id)
    {
        ...
        return view('manufacturers.address',compact('id','page_title','user'));
    }
    ...
    public function jobs($id)
    {
        ...
        return view('manufacturers.jobs',compact('id','job_listing'));
    }
    ...
    public function job_create($id)
    {
        ...
        return view('manufacturers.job_create',compact('id','job_categories'));
    }
    ...
    public function job_store(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('manufacturers.jobs',[$id])
    ...
    public function job_edit($id, $user_id)
    {
        ...
        if(!isset($job_data)) {
            return redirect()->route('manufacturers.jobs',$user_id)
        ...
        return view('manufacturers.job_edit',compact('id','user_id','job_categories','job_data','job_images'));
    }
    ...
    public function job_image_destroy($image_id, $id)
    {
        ...
        $job_image->delete();
        return redirect()->route('manufacturers.job_preview', ['job_id' => $job_id, 'id' => $id] )
    ...
    public function job_image_destroy_edit($image_id, $id)
    {
        ...
        $job_id = $job_image->job_id;
        $job_image->delete();
        return redirect()->route('manufacturers.job_a_edit', ['job_id' => $job_id, 'id' => $id] )
                            ->with('success','Job deleted successfully');
    }
    ...
    public function jobs_a($id)
    {
        ...
        return view('manufacturers.jobs_a',compact('id','job_listing'));
    }
    ...
    public function job_a_create($id)
    {
        ...
        return view('manufacturers.job_a_create',compact('id','job_categories','job_types'));
    }
    ...
    public function job_store_a(Request $request, $id)
    {
        ...
        // return back();
        return redirect()->route('manufacturers.job_preview',[$job_id,$id]);
    }
    ...
    public function job_preview($job_id, $id)
    {
        ...
        if(!isset($jobs)) {
            return redirect()->route('manufacturers.jobs_a',$user_id)
            ->with('warning','Job not found');
        }
        ...
        return view('manufacturers.job_preview',compact('job_id','id','job_categories','job_types','jobs','job_images','user_data'));
    }
    ...
    public function job_a_edit($job_id, $id)
    {
        ...
        return view('manufacturers.job_a_edit',compact('job_id','id','job_categories','job_types','job_data','job_images'));
    }
    ...
    public function job_post($job_id, $id)
    {
        ...
        $input['previewed'] = 1;
        $jobs->update($input);
        return redirect()->route('manufacturers.jobs_a',[$id])->with('success','Requirement posted successfully');
    }
    ...
    public function job_a_destroy($id, $job_id)
    {
        $job = Job::find($job_id);
        if(!isset($job)) {
            return redirect()->route('manufacturers.jobs_a',$id)
            ->with('warning','Job not found');
        }
        $job->delete();
        return redirect()->route('manufacturers.jobs_a',$id)
    ...
    public function reviews($id)
    {
        ...
        return view('manufacturers.reviews',compact('id','received_reviews','sent_reviews'));
    }
    ...
    public function delete_review($review_id, $id) {
        ...
        // return redirect()->route('manufacturers.reviews',$id)->with('success','Review deleted successfully');
    }
    // Reviews Section end
    ...
    public function enquiries($id,$enq_id=0)
    {
        ...
        return view('manufacturers.enquiries',compact('id','enq_id','user_details','contact_list','all_messages','messages_list','messages_user_data_all','added_contact'));
    }
    ...
    public function start_chat($id,$room_user_id)
    {
        ...
        return redirect()->route('manufacturers.enquiries',[$id,$enq_id]);
                        ...
                        <div class="d-flex align-items-center aasdiv">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-grow border-bottom">
                                ...
                                <div class="d-flex align-items-end text-body">
                                    <a
                                        href="'.url("dashboard/manufacturers/enquiries/start_chat/".$id."/".$user_data->id).'">
                                    ...
                                    <a
                                        href="'.url("dashboard/manufacturers/enquiries/save_contact/".$id."/".$user_data->id."/".$enq_id).'">
    ...
    public function delete_enquiry($enquiry_id, $id) {
        ...
        return redirect()->route('manufacturers.enquiries',$id)
